...
if __name__ == '__main__':
    ...
    secret_key = ""
    passphrase = ""
    channels = ['orderBookL2_25.BTCUSD','order']
    trade_param = ""

    #subscribe API
    subscribeAPI = subscribe(url, api_key, passphrase, secret_key, channels)

    #trade API
    tradeAPI = trade(url, api_key, passphrase, secret_key, trade_param)
